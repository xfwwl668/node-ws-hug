...
const UUID = process.env.UUID || 'ca78f467-7e1c-4dd7-be1c-91991445127b'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'HvfRw5cDcTBC1G38bin6eOgALoA4fldF';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = process.env.DOMAIN || 'https://xfwwl-8080-mgxow-jwhn.outplane.app';    // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
...
const NAME = process.env.NAME || 'outplane_';                       // 节点名称
